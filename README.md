...
<p align="center">
<img src=".github/formulario-mentoria.gif">
</p>
...
Working with HTML inputs, understanding how web forms work, knowing how to differentiate between GET and POST methods, configuring the Live server in VS Code, working with pseudo-elements in CSS, validating form fields.
...
You can view the layout of the project through [THIS LINK](https://www.figma.com/file/U1Rcey7opzxuQqYsw8Jg4S/Stage-03---Formul%C3%A1rio-avan%C3%A7ado-(Copy)?node-id=0%3A1). You need an account on [Figma](https://figma.com) to access it.


## 🚀 Deploy

https://ricardodev10.github.io/formulario-avalie-sua-mentoria/
